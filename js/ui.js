...
const UI = (() => {
      ...
      <div class="g2">
        ...
        <div class="card">
          ...
          <div class="btn-row" style="margin-top:10px;flex-wrap:wrap">
            ...
            <select id="nt" style="width:130px">
    ...
    document.getElementById('pane4').innerHTML=`
      ${(close||_magFilter)?`<div class="mag-glass-note">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-top:10px;flex-wrap:wrap">
          <select id="mag-branch-sel" style="flex:1;min-width:160px">
  ...
  function renderSessionHistory(history) {
    ...
    el.innerHTML=history.map((v,i)=>`
      <div class="session-item ${i===0?'current':''}" onclick="Session.loadVersion(${v.id})" role="button" tabindex="0">
